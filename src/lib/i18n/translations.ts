...
export const UI_STRINGS: Record<string, Record<Language, string>> = {
  ...
  'market.received': { en: 'Requests received', zh: '收到的申请' },
  'market.sent': { en: 'Requests you sent', zh: '你发出的申请' },
  'market.awaiting_you': { en: 'awaiting your reply', zh: '待你回复' },
  'market.nothing_posted': { en: 'You haven’t posted anything yet.', zh: '你还没有发布任何信息。' },
  'market.nothing_sent': { en: 'You haven’t raised a hand on anything yet.', zh: '你还没有对任何信息表达兴趣。' },
  ...
  'notif.empty': { en: 'Nothing yet. The Republic will let you know.', zh: '暂无通知。有消息时会通知你。' },
  'notif.mark_all_read': { en: 'Mark all read', zh: '全部标为已读' },
  'notif.close': { en: 'Close', zh: '关闭' },
  'notif.just_now': { en: 'just now', zh: '刚刚' },
  'notif.minutes_ago': { en: '{n}m ago', zh: '{n} 分钟前' },
  'notif.hours_ago': { en: '{n}h ago', zh: '{n} 小时前' },
  'notif.days_ago': { en: '{n}d ago', zh: '{n} 天前' },
  // {name} is the other member, {listing} the listing title.
  'notif.interest_raised': { en: '{name} raised a hand on {listing}', zh: '{name} 对「{listing}」举手了' },
  ...
  'notif.someone': { en: 'Someone', zh: '某位同学' },
